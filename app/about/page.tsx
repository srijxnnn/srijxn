  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <main className="flex-1 container mx-auto px-8 py-12 max-w-5xl">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-muted-foreground leading-relaxed">
                      I&apos;m a passionate full-stack developer with the
                      experience of building modern web applications. I love
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      in continuous learning and staying up-to-date with the
